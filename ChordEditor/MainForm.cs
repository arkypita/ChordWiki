...
namespace ChordEditor
{
	...
	public partial class MainForm : Form
	{
		...
		{
			if (MessageBox.Show("Questo comando andrà a modificare tutti i file (escluso quelli bloccati) nel database effettuando una pulizia e normalizzazione dei contenuti. Usare solo se si è consapevoli di cosa si sta facendo!!!", "Attenzione!", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) == DialogResult.OK)
